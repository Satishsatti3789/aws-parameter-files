...
variable "params" {
  default = [
    { name = "roboshop.dev.frontend.catalogue_url", value = "http://catalogue-dev.devopsprojects.store/", type = "String" },
    { name = "roboshop.dev.frontend.user_url", value = "http://user-dev.devopsprojects.store/", type = "String" },
    { name = "roboshop.dev.frontend.cart_url", value = "http://cart-dev.devopsprojects.store/", type = "String" },
    { name = "roboshop.dev.frontend.payment_url", value = "http://payment-dev.devopsprojects.store/", type = "String" },
    { name = "roboshop.dev.frontend.shipping_url", value = "http://shipping-dev.devopsprojects.store/", type = "String" },
    ...
    { name = "roboshop.prod.frontend.user_url", value = "http://user-prod.devopsprojects.store/", type = "String" },
    { name = "roboshop.prod.frontend.cart_url", value = "http://cart-prod.devopsprojects.store/", type = "String" },
    { name = "roboshop.prod.frontend.payment_url", value = "http://payment-prod.devopsprojects.store/", type = "String" },
    { name = "roboshop.prod.frontend.shipping_url", value = "http://shipping-prod.devopsprojects.store/", type = "String" },
    ...
    { name = "roboshop.prod.payment.amqp_host", value = "rabbitmq-prod.devopsprojects.store", type = "String" },
